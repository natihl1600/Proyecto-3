...
#__________/Textos // textos incluídos a la ventana del test drive
    ...
    NombrePiloto = Label(canvas, text = nombres, font = ('Arial', 15), bg = 'skyblue', fg = 'white')
    NombrePiloto.place(x=585,y = 55)
    NombreEscuderia = Label(canvas, text = escuderias, font = ('Arial', 15), bg = 'skyblue', fg = 'white')

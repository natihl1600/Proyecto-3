...
void procesar(String input, String * output){
  ...
  while(delComa>0){
    ...
    */
    ...
    else if (comando == "Movimiento especial1"){
      implementar ("pmw", "1022");
      implementar ("dir", "0");
      delay (3000);
      implementar ("pmw", "-1022");
      delay (3000);
    ...
    else if (comando == "Movimiento especial2"){
      implementar ("pmw", "1022");
      implementar ("dir", "1");
      delay (5000);
      implementar ("pmw", "-1022");
